...
export function initDiamondPartners(node) {
  node.innerHTML = `
    ...
    ${shuffleArray(partners)
      ...
      <a href="${partner.url}">
        ...
        ${
          partner.title &&
          `<span class="description">${partner.title}</span>`
        }
      </a>
      </li>
      `
...
const partners = [
  ...
  },
  {
    ...
    title:
      'Mulig du er et geni, men funker du sammen med andre glupinger?',
  ...
  },
  {
    name: 'Noa Ignite',
    lightLogo:
      'https://www.dagbladet.no/files/2023/03/07/kode24-partner-noa-ignite-light.png',
    darkLogo:
      'https://www.dagbladet.no/files/2023/03/07/kode24-partner-noa-ignite-dark.png',
    title: 'Vi er Norges ledende hus på Sanity og Optimizely',
    url: 'https://www.kode24.no/partner/noa-ignite',
  },
  {
    name: 'Kodebyraaet',
    lightLogo:
      'https://www.dagbladet.no/files/2023/03/10/kode24-partner-kodebyraaet-light.png',
    darkLogo:
      'https://www.dagbladet.no/files/2023/03/10/kode24-partner-kodebyraaet-dark.png',
    title:
      'At Kodebyraaet we always strive to make things with an edge, ',
    url: 'https://www.kode24.no/partner/kodebyraaet',
  },
  {
    name: 'PwC',
    lightLogo:
